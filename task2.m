...
facility.Position.AssignGeodetic(45.5889,-73.5616,0);

%%
satellite = scenario.Children.New('eSatellite','SunSat1'); 

keplerian = satellite.Propagator.InitialState.Representation.ConvertTo('eOrbitStateClassical');
% keplerian.Type = 'eCriticallySunSync';
% keplerian.SizeShapeType = 'eCriticallySunSync';
...
keplerian.SizeShape.PerigeeAltitude = 1688;
keplerian.SizeShape.ApogeeAltitude = 1688;
keplerian.Orientation.Inclination = 103.008;
keplerian.Orientation.ArgOfPerigee = 0;
keplerian.Orientation.AscNode.Value = 284.8873;
keplerian.Location.Value = 90;
satellite.Propagator.InitialState.Representation.Assign(keplerian);
satellite.Propagator.Propagate;

%%
satellite = scenario.Children.New('eSatellite','SunSat2'); 
...
keplerian.LocationType = 'eLocationTrueAnomaly';
keplerian.Orientation.AscNodeType = 'eAscNodeLAN';
keplerian.SizeShape.PerigeeAltitude = 901;
keplerian.SizeShape.ApogeeAltitude = 901;
keplerian.Orientation.Inclination = 99.0427;
keplerian.Orientation.ArgOfPerigee = 0;
keplerian.Orientation.AscNode.Value = 60;
keplerian.Location.Value = 90;
satellite.Propagator.InitialState.Representation.Assign(keplerian);
satellite.Propagator.Propagate;
